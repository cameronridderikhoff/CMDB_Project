...
window_lookup.create_button(const.LOOKUP_BUTTON, const.FUNCT["LOOKUP"], 0, LEFT)
...
window_main.create_button(const.SAVE, const.FUNCT["EDIT_FILE"], len(const.TEXT),args=[window_lookup])
window_main.create_button(const.EXIT, const.FUNCT["SWAP_WINDOW"], len(const.TEXT)+1,args=[window_lookup])
