...
2. run the powershell command "python CMDB.py"
...
7. Delete entry will COMPLETELY REMOVE the entry with no warning. Be careful wth using this button.

Please fill in all information available. Contact Rod Johnson if there is a field that doesn't make sense, and if the Help button doesnt explain it well enough.
