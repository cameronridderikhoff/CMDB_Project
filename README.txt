This software belongs to SRIT - Science Research IT group for the University of Alberta. (2019)

This program requires python3, sqlite3 and tkinter. If the program produces an error based on any of these systems, please ensure they are all properly installed before 
considering contacting Rod.
...
Please fill in all information available. Contact Rod Johnson (rodj@ualberta.ca) if there is something that doesn't make sense, and if the Help button doesn't explain it well enough.